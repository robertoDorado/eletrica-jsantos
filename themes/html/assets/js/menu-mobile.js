const menuMobile = document.getElementById("menuCategoryMobile")
...
if (menuMobile) {
    menuMobile.addEventListener("click", function () {
        ...
        if (!subMenuMobile.classList.contains("show")) {
            subMenuMobile.classList.add("show")
            document.getElementById("angleDownIconMobile").classList.remove("fa-angle-down")
            document.getElementById("angleDownIconMobile").classList.add("fa-angle-up")
        }else {
